...
public class WebRoute
{
    ...
    public readonly static Func<ReqDtoGetOrUpdateUserMissionList, string> GetOrUpdateUserMissionList = (dto) => $"{BaseUrl}User/GetOrUpdateUserMissionList?UserAccountId={dto.UserAccountId}&List={dto.List}";
...
public class WebContentsManager
{
    ...
    public void GetOrUpdateUserMissionList(ReqDtoGetOrUpdateUserMissionList requestDto, Action<ResDtoGetOrUpdateUserMissionList> onSuccess = null, Action<EStatusCode> onFailed = null)
    {
        Managers.Web.SendGetRequest(WebRoute.GetOrUpdateUserMissionList(requestDto) , (response) =>
        {
